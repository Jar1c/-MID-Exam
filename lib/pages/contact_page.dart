...
class ContactPage extends StatelessWidget {
  final List contactItems = [
    ...
    ContactInfo(Icons.phone, 'Phone', '09283875420', Colors.green),
    ...
    ContactInfo(Icons.language, 'Website', 'https://grc.edu.ph/contact-us/', Colors.purple),
  ];
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Icon(Icons.contact_mail, size: 80, color: Colors.red),
                    SizedBox(height: 20),
                    Text('Get In Touch', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.red)),
                    SizedBox(height: 10),
                    Text('PHYSICAL ADDRESS 454 GRC BLDG. Rizal Ave. Cor. 9th ave. East Grace Park, Caloocan City 1400 Metro Manila.', style: TextStyle(fontSize: 16, color: Colors.grey[600]), textAlign: TextAlign.center),
                  ],
                ),
              ),
